...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* sidebar mobile */}
      <aside
        className={`lg:hidden fixed inset-0 left-0 w-72 bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col transform transition-transform duration-300
